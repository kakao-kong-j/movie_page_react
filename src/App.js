      ...
      <Router>
        <div>
          ...
          <Switch>
            ...
            />
            <Route
              path={basicPath + "/login"}
              name="login"
              component={this.authCheck(true)}
            />
            <Route
              path={basicPath + "/Signup"}
              name="Signup"
              component={this.authCheck(false)}
            />
            <Route
              path={basicPath + "/MovieDetail/:id"}
              name="MovieDetail"
