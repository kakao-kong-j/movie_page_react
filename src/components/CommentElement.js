  ...
  deleteComment() {
    this.removeListener = firebaseAuth().onAuthStateChanged(user => {
      if (user.email === this.props.email) {
        let DBref_Comment_id = database
          .ref()
          .child("Comment")
          .child(this.props.id)
          .child(this.props.commentid);
    ...
    return (
      <div>
        {this.props.commentvalue && (
          <div
            id="commentElement"
            className="comment col-lg-11mb-2 row bg-light border border-info w-100"
          >
            ...
            <div className="comment-content col-md-11 col-sm-10">
              ...
              <div className="d-flex justify-content-start">
                <div className="align-self-center p-1 small">Rating:</div>
                <div className="p-2">
                  <Rate
                    size={15}
                    count={5}
