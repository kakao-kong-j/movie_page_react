...
class Introduce extends Component {
    ...
    return (
        ...
        <div className="video-foreground">
          <iframe title="movie_player" id="movie_player"src="https://www.youtube.com/embed/B65hW9YYY5A?controls=0&showinfo=0&rel=0&autoplay=1&loop=1&start=3&cc_load_policy=0" frameBorder="0" allowFullScreen></iframe>
        </div>
      </div>
